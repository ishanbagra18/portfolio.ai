import SectionRenderer, { useSectionNumber } from '../../components/SectionRenderer';
...
const SectionHeader = ({ fallbackNum, command, colorClass = "text-cyan-400" }) => {
  const sectionNumber = useSectionNumber(fallbackNum);
  return (
    <h2 className={`text-lg font-bold text-white mb-6 flex items-center gap-2 ${colorClass} uppercase`}>
      <span>[{sectionNumber}]</span> {command}
    </h2>
  );
};
...
const Template8 = ({ publicData, isPublicView }) => {
  ...
  const sectionMap = {
    about: pInfo.about_paragraph ? (
      <section className="max-w-7xl mx-auto px-6 py-12">
        <SectionHeader fallbackNum="01" command="cat profile_data.log" colorClass="text-cyan-400" />
    ...
    tech_stacks: tStacks.length ? (
      <section className="max-w-7xl mx-auto px-6 py-12">
        <SectionHeader fallbackNum="02" command="./list_skills.sh" colorClass="text-[#39FF14]" />
    ...
    projects: projs.length ? (
      <section className="max-w-7xl mx-auto px-6 py-12">
        <SectionHeader fallbackNum="03" command="ls -la ~/projects" colorClass="text-[#FF007F]" />
    ...
    experiences: exps.length ? (
      <section className="max-w-7xl mx-auto px-6 py-12">
        <SectionHeader fallbackNum="04" command="cat ~/work_history.json" colorClass="text-yellow-400" />
    ...
    certifications: certs.length ? (
      <section className="max-w-7xl mx-auto px-6 py-12">
        <SectionHeader fallbackNum="05" command="query --certifications" colorClass="text-cyan-400" />
