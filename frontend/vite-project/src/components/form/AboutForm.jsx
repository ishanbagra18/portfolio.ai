      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col md:col-span-2">
          <div className="flex justify-between items-center mb-3">
            <label className="text-sm font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest">About Paragraph</label>
            <button
              type="button"
              onClick={handlePolish}
              disabled={polishing}
              className="text-xs font-bold text-violet-600 dark:text-violet-400 hover:text-pink-600 uppercase tracking-wider flex items-center gap-1.5 transition-colors disabled:opacity-50"
            >
              {polishing ? (
                <>
          ...
          <textarea 
            ...
            rows="4"
            className="bg-transparent border-b-2 border-zinc-300 dark:border-zinc-800 text-xl text-[var(--neo-text)] py-3 focus:outline-none focus:border-pink-500 dark:focus:border-white transition-colors placeholder:text-zinc-400 dark:placeholder:text-zinc-600 resize-none"
          ></textarea>
        </div>

        {/* Education Details */}
        <div className="flex flex-col md:col-span-2">
          <label className="text-sm font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-3">College / University Name</label>
          <input 
            ...
            className="bg-transparent border-b-2 border-zinc-300 dark:border-zinc-800 text-xl text-[var(--neo-text)] py-3 focus:outline-none focus:border-pink-500 dark:focus:border-white transition-colors placeholder:text-zinc-400 dark:placeholder:text-zinc-600"
          />
        </div>

        <div className="flex flex-col">
          <label className="text-sm font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-3">Course Name</label>
          <input 
        ...
        <div className="flex flex-col">
          <label className="text-sm font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-3">Specialization</label>
          <input 
        ...
        {/* Coding Profiles */}
        <div className="flex flex-col">
          <label className="text-sm font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-3">GitHub Username</label>
          <input 
        ...
        <div className="flex flex-col">
          <label className="text-sm font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-3">LeetCode Username</label>
          <input 
        ...
        <div className="flex flex-col md:col-span-2">
          <label className="text-sm font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-3">
            Resume URL
            <span className="ml-2 text-zinc-500 dark:text-zinc-400 font-normal normal-case tracking-normal text-xs">
          ...
          {data.resume_url && (
            <a
              ...
              className="mt-2 text-xs text-zinc-500 dark:text-zinc-400 hover:text-pink-600 transition-colors flex items-center gap-1.5 w-fit"
            >
